  ...
  <script>
    ...
    function ordenarID() {
      ...
      for (let i = 0; i < numero; i++) {
        tabla.append("<tr><th scope='row'><input type='checkbox' class='checkbox-list'></th><td onclick='irAFicha(this)'><input type='hidden' value='"+pinchos[i].cod_pincho+"' />" + pinchos[i].nombre + "</td><td onclick='irAFicha(this)'>" + pinchos[i].descripcion + "</td><td onclick='irAFicha(this)'>" + pinchos[i].precio + "€</td><td onclick='irAFicha(this)'>" + pinchos[i].bar + "</td></tr>");
      }
    }
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          for (let i = 0; i < response.length; i++) {
            tabla.append("<tr><th scope='row'><input type='checkbox' class='checkbox-list'></th><td onclick='irAFicha(this)'><input type='hidden' value='"+response[i].cod_pincho+"' />" + response[i].nombre + "</td><td onclick='irAFicha(this)'>" + pinchos[i].descripcion + "</td><td onclick='irAFicha(this)'>" + response[i].precio + "€</td><td onclick='irAFicha(this)'>" + response[i].bar + "</td></tr>");
          }
