...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-01-2022 a las 16:11:09
...
(2, 'Bar Lorenzo \"Tío Agus\"', 42.65444, -2.4419),
...
('diego@gmail.com', '1234', 0, 'Diego Lopez'),
...
(4, 'diego@gmail.com', 6, 'Estaba pocho', 1);
...
--
ALTER TABLE `bares`
  MODIFY `cod_bar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pinchos`
  MODIFY `cod_pincho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `favoritos`
  ADD CONSTRAINT `favoritos_ibfk_1` FOREIGN KEY (`pincho`) REFERENCES `pinchos` (`cod_pincho`),
  ADD CONSTRAINT `favoritos_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`);

--
-- Filtros para la tabla `fotos_bares`
--
ALTER TABLE `fotos_bares`
  ADD CONSTRAINT `fotos_bares_ibfk_1` FOREIGN KEY (`bar`) REFERENCES `bares` (`cod_bar`);

--
-- Filtros para la tabla `fotos_pinchos`
--
ALTER TABLE `fotos_pinchos`
  ADD CONSTRAINT `fotos_pinchos_ibfk_1` FOREIGN KEY (`pincho`) REFERENCES `pinchos` (`cod_pincho`);

--
-- Filtros para la tabla `likes_pincho`
--
ALTER TABLE `likes_pincho`
  ADD CONSTRAINT `likes_pincho_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`),
  ADD CONSTRAINT `likes_pincho_ibfk_2` FOREIGN KEY (`pincho`) REFERENCES `pinchos` (`cod_pincho`);

--
-- Filtros para la tabla `likes_valoracion`
--
ALTER TABLE `likes_valoracion`
  ADD CONSTRAINT `likes_valoracion_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`),
  ADD CONSTRAINT `likes_valoracion_ibfk_2` FOREIGN KEY (`valoracion`) REFERENCES `valoraciones` (`cod_valoracion`);

--
-- Filtros para la tabla `pinchos`
--
ALTER TABLE `pinchos`
  ADD CONSTRAINT `pinchos_ibfk_1` FOREIGN KEY (`bar`) REFERENCES `bares` (`cod_bar`);

--
-- Filtros para la tabla `valoraciones`
--
ALTER TABLE `valoraciones`
  ADD CONSTRAINT `valoraciones_ibfk_1` FOREIGN KEY (`pincho`) REFERENCES `pinchos` (`cod_pincho`),
  ADD CONSTRAINT `valoraciones_ibfk_2` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`);
COMMIT;
